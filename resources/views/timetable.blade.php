...
<script>
    ...
    for (let i = 0; i < timeTable.length; i++) {
        document.getElementById('table').innerHTML += `<tr><td>${i + 1}</td><td>${timeTable[i].CourseCode}</td><td>${timeTable[i].Instructor}</td><td>${timeTable[i].Day}</td><td>${timeTable[i].Time}</td></tr>`
